...
| [`06`](results/loop-06-fp8-fa-vs-aiter-asm-rocprofv3.md) | `ANALYSIS`: rocprofv3 comparative deep-dive localized the asm-fp8 parity gap to the **MMA intrinsic width** — aiter uses `32x32x64` (65536 MACs/op), FlyDSL `32x32x16` (16384), 4× narrower. | Revised the earlier "purely stall-bound, MMA ~8%" framing: the stalls are downstream of issuing 4× as many MFMAs. Produced the concrete, testable next hypothesis (adopt the wide atom) executed in loop 07. |
